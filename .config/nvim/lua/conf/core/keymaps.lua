...
-- Navigate buffers
keymap("n", "<leader>z", ":BufferLineCyclePrev<CR>", "Previous buffer")
keymap("n", "<leader>x", ":BufferLineCycleNext<CR>", "Next buffer")
keymap("n", "<leader>e", ":Telescope find_files<CR>", "Open Files")
